...
export default function Services() {
  ...
  return (
    <motion.div
      ...
      id="services"
      className="relative flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 pt-30 text-gray-700 dark:text-white"
    >
      <img
        src={assets.bgImage2}
        alt=""
        className="absolute -top-10 -left-70 -z-1 dark:hidden"
      />
